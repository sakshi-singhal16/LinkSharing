	...
	<body>
		...
		<div id="show-documentResource" class="content scaffold-show" role="main">
			...
			<ol class="property-list documentResource">
				...
				<g:if test="${documentResourceInstance?.readingIntems}">
				<li class="fieldcontain">
					<span id="readingIntems-label" class="property-label"><g:message code="documentResource.readingIntems.label" default="Reading Intems" /></span>
