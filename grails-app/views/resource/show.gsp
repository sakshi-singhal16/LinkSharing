	...
	<body>
		...
		<div id="show-resource" class="content scaffold-show" role="main">
			...
			<ol class="property-list resource">
				...
				<g:if test="${resourceInstance?.readingIntems}">
				<li class="fieldcontain">
					<span id="readingIntems-label" class="property-label"><g:message code="resource.readingIntems.label" default="Reading Intems" /></span>
